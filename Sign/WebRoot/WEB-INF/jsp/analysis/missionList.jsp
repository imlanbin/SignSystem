...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  ...
  <body>
<!-- 数据列表  开始 -->
 	<table id="dg" title="词语列表" data-options="queryParams:{str: '1=1'},url:atermSrv.findAllPage,onLoadSuccess:changeBtn" class="easyui-datagrid"   toolbar="#toolbar" pagination="true"    rownumbers="true" fitColumns="false" singleSelect="false" collapsible="true"  autoRowHeight="true"    pageList="[10,20,30,40,50]" sortName="terms"  >  
        <thead>  
            <tr> 
            	<th field="atid" checkbox="true" width="100"></th>
		        <th field="terms" sortable="true"  width="200">词语</th> 
				<th field="state" width="100"  data-options="formatter:formatState">状态</th> 
				<th field="state1" width="100"  data-options="formatter:formatBtn">操作</th> 
            </tr>  
        </thead>  
    </table>  
    <div id="toolbar">  
 ...
 <!-- 数据列表  结束 --> 
 <!-- 添加数据窗口  开始 -->  
	<div id="term-window" title="词语窗口" style="width:400px;height:150px;">
 ...
 <!-- 添加数据窗口  结束 -->  
	...
	function updateTerm(){ 
		/* var termm = {
		 ...
		 var termm = form.serializeObject();
