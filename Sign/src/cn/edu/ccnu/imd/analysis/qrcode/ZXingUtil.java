package cn.edu.ccnu.imd.analysis.qrcode;
...
public class ZXingUtil {
	...
	public static void main(String[] args) {
		encodeQRCodeImage("http://blog.csdn.net/imlanbin", null, "C:/myQRCodeImage.png", 300, 300, "C:/Users/epdev/Desktop/webpage-design-05.png");
//		System.out.println(decodeQRCodeImage("C:/123456.png", null));
	}
	...
	public static boolean encodeQRCodeImage(String content, String charset, String imagePath, int width, int height, String logoPath) {
		...
		MatrixToImageConfig config = new MatrixToImageConfig(0xFF00F0A1, 0xFFFFFFFF);
